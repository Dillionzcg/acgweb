...
有一点用户问及时一定要知道。该网站注册用的手机号和邮箱是不用验证码的，为了降低用户的注册门槛。但注册和修改的时候都必须如实确认”该信息是否真实“(网页上叫做”身份契约确认“)。用户只要选择了”该信息不是真实的“，就可以
尽情拿手机号和邮箱整活了，(问到的时候概括性地说，主要是确认真实性的重要性,同时提示并鼓励用户”可以选择非真实然后整活“)
